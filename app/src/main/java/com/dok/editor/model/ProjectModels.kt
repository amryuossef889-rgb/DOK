...
data class Project(
    ...
    val width: Int = 1920, val height: Int = 1080, val fps: Int = 30, val schemaVersion: Int = 2,
    val tracks: List<Track> = emptyList(), val mediaPool: List<MediaAsset> = emptyList(), val effectLibrary: List<ExternalEffectAsset> = emptyList(), val createdAtMs: Long = System.currentTimeMillis(),

...
@Composable
fun ProjectSettingsDialog(project: Project, onDismiss: () -> Unit, onCommand: (EditorCommand) -> Unit, onShortcuts: () -> Unit, onRecovery: () -> Unit = {}) {
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                TextButton(onClick = onShortcuts) { Text("Keyboard shortcuts") }
                TextButton(onClick = onRecovery) { Text("Project recovery") }
            }
        },
        confirmButton = {
            Button(
